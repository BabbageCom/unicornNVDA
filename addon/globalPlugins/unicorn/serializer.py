...
from . import callbackCommandsDatabase, transport
    ...
    def default(self, obj):
        if is_subclass_or_instance(obj, SEQUENCE_CLASSES):
            ...
            if is_subclass_or_instance(obj, (speech.commands.CallbackCommand,)):
                ...
                callbackCommandsDatabase.callBackDatabase[
                    callbackCommandsDatabase.ii
                ] = callbackFunction
                callbackDict = {
                    "compName": callbackCommandsDatabase.compName,
                    "index": callbackCommandsDatabase.ii,
                }
